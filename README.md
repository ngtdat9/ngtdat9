...
<ul align="left">
  <li><b>Software Engineering:</b> Object-oriented programming, API development, version control, unit testing fundamentals</li>
  <li><b>Machine Learning:</b> Data preprocessing, classical ML algorithms, model training & evaluation</li>
  <li><b>Deep Learning (Intro):</b> Foundational neural networks, model experimentation</li>
  <li><b>Backend Development:</b> REST API design, authentication, database integration</li>
  <li><b>Frontend Development:</b> Component-based UI development, basic state management</li>
  <li><b>Databases:</b> SQL / NoSQL fundamentals, basic schema design & querying</li>
  <li><b>Cloud & DevOps (Intro):</b> Docker, basic AWS services, CI/CD awareness</li>
  <li><b>Tools & Workflow:</b> Git / GitHub, Linux environment, VS Code</li>
</ul>
